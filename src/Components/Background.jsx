...
function Background() {
  return ( 
    ...
    <div className="w-full h-[80vh]  mt- bg-zinc-00 bg-[url('https://png.pngtree.com/thumb_back/fh260/background/20190221/ourmid/pngtree-summer-ice-cream-ice-cream-propaganda-image_11340.jpg')] bg-cover top-1/2  bg-no-repeat   bg-center ">
      <h1 className='absolute top-[25%] left-[50%] lg:w-68  translate-x-[-50%] translate-y-[-50%] font-sans text-[3vh] md:text-[4vh] lg:text-[7vh] 2xl:text-[10vh] text-blue-800 tracking-wide font-semibold  md:w-[60vw]' > ICE CREAME CAFE.</h1>
    ...
    <div className='w-[100%] h-[50%] bg-zinc-100 '>
      ...
      <div className='h-3/4 w-3/4 bg-[#c1ff76] pl-5 pt-10 h-[50vh]  md:w-[70vw] md:h-[30vh] rounded-md flex  justify-around'>
